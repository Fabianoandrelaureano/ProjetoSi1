...
//	private List<Usuario> usuarios = new ArrayList<Usuario>();
	...
	private ControladorDeBD(){
		...
		Viagem[] travels = {new Viagem("Coxixola","09/Outubro/2014", "Terra dos coxixos.", users[0]), new Viagem("Caverna de Gelo", "11/Novembro/2014", "Se escondendo do frio.", users[0]), new Viagem("Nova York", "20/Novembro/2014", "Ida ate a estatua da liberdade.", users[1]), 
				new Viagem("Los Angeles", "23/Dezembro/2014", "Viagem com o grupo vindo de SP.", users[2]), new Viagem("Alasca", "24/Dezembro/2014", "Pra todos que querem curtir o Inverno do Alasca.", users[2]), new Viagem("Tangamandapia", "28/Dezembro/2014", "Visita especial a casa de Jaiminho, o Carteiro.", users[3]), 
				new Viagem("Cidade do Mexico", "28/Dezembro/2014", "Comer uns tacos, conhecer outra cultura, quem quiser ir e so chegar junto.", users[4]), new Viagem("Polo Norte", "28/Dezembro/2014", "Visita e homenagem a Papai Noel.", users[5]), new Viagem("Antartida", "30/Dezembro/2014", "Viagem de estudo, o tema sao as auroras.", users[6]), 
				new Viagem("Iraque", "04/Janeiro/2015", "Viagem com o grupo de Eng. de Petroleo vindo de Osasco.", users[7]), new Viagem("Coreia do Norte", "07/Fevereiro/2015", "Visita aos pontos turisticos que marcaram a ditadura Norte Coreana.", users[12]), new Viagem("Siberia", "10/Fevereiro/2015", "Viagem do grupo de estudos de Biologia.", users[14]), 
				new Viagem("Madagascar", "27/Abril/2015", "Safari em Madagascar, pra comprar uma entrada, ligue para 9988-0552.", users[15]), new Viagem("Ilhas Maldivas", "29/Abril/2015", "Festa na Ilha, com bandas locais.", users[16]), new Viagem("Falklands", "15/Maio/2015", "Visita para analise do clima e principais pontos da guerra.", users[17]), 
